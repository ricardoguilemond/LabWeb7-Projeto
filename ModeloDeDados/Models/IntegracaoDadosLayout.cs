...
public partial class IntegracaoDadosLayout
{
    ...
    public virtual ICollection<IntegracaoDadosExecucao> IntegracaoDadosExecucao { get; set; } = new List<IntegracaoDadosExecucao>();

    public virtual ICollection<LogArquivos> LogArquivos { get; set; } = new List<LogArquivos>();
}
